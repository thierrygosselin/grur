...
Please follow instructions in the vignette to install required packages for the
selected imputation options below:

| imputation options | package | install instructions |
|:-------------------|:-------------------------:|-------------------------------|
|**imputation.method = "lightgbm"**|`lightgbm`|vignette|
|**imputation.method = "xgboost"**|`xgboost`|vignette|
|**imputation.method = "rf"**|`randomForestSRC`|vignette|
|**imputation.method = "rf_pred"**|`ranger`|`install.packages("ranger")`|
|**imputation.method = "bpca"**|`pcaMethods`|`source("https://bioconductor.org/biocLite.R")`
`biocLite("pcaMethods")`|
