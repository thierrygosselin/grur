...
Please follow instructions in the [vignette](https://www.dropbox.com/s/yfxgr8vujvv2kut/vignette_grur.nb.html?dl=0) to install required packages for the
selected imputation options below:

| imputation options | package | install instructions |
|:-------------------|:-------------------------:|-------------------------------|
|**imputation.method = "lightgbm"**|`lightgbm`|[vignette](https://www.dropbox.com/s/yfxgr8vujvv2kut/vignette_grur.nb.html?dl=0)|
|**imputation.method = "xgboost"**|`xgboost`|[vignette](https://www.dropbox.com/s/yfxgr8vujvv2kut/vignette_grur.nb.html?dl=0)|
|**imputation.method = "rf"**|`randomForestSRC`|[vignette](https://www.dropbox.com/s/yfxgr8vujvv2kut/vignette_grur.nb.html?dl=0)|
